...
Что нужно сделать: создаnm класс Radio, в котором храните следующие поля (т.е. данные, которые будут помнить о себе объекты радио):
...
Добиться уровня покрытия по веткам 100%
